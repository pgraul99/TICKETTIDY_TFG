...
public partial class AsignarIncidencias : ContentPage
{
    ...
    public async Task CargarIncidencias()
    {
        ...
        try
        {
            ...
            var incidenciasHTTP = await HTTPHelper.GetAll<Incidencia>(
                "http://tickettidy.somee.com/getIncidenciasSinAsignar");
    ...
    private void viajarIncidencia_Clicked(object sender, EventArgs e)
    {
        ...
        App.Navigate.PushAsync(new AccionAsignarIncidencia());
        var a = 2;
    }
}